...
@Component(service=ParticipantStepChooser.class,
	immediate= true,
	property={"ParticipantStepChooser.SERVICE_PROPERTY_LABEL=Legal Approver Selecton Process"})
public class LegalApproverSelectonProcess implements ParticipantStepChooser{
	...
	public String getParticipant(WorkItem item, WorkflowSession wfSession, MetaDataMap metadata) throws WorkflowException {
		...
		try {
			...
			if(localGroupName != null ){
				participant = localGroupName+UserGroupsConsts.LEGAL_LOCAL_GROUP_SUFFIX;
