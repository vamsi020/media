...
@Component(service=ParticipantStepChooser.class,
	immediate= true,
	property={"ParticipantStepChooser.SERVICE_PROPERTY_LABEL=Asset Approver Selection Process"})
public class AssetApproverSelectionProcess implements ParticipantStepChooser{
